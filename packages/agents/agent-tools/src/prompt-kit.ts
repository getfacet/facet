...
- Use get_brick_spec before authoring unfamiliar media icon fields, table alignment, table width, emptyLabel, chart lineStyle, chart axis, or local style paths; call get_style_choices for unfamiliar style values such as textWrap, lineClamp, dividers, stickyHeader, axisColor, gridColor, or labelColor.
