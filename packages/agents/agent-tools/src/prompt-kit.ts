...
export const FACET_PROMPT_KIT = [
  ...
  "Content classes are discovery guidance only: Leaf accepts no children, Container accepts direct children, and Structured uses declared named slots. A simple screen may contain components directly. Do not add layout wrappers that do not change arrangement.",
  ...
  "Inside Screen roots, use only component tags present in the active catalog. For unknown contracts, call read_component_spec; follow authoringGuide.elementSyntax and directChildRule before its content mode, slot cardinalities and allowed tags, structured prop shapes, asset kinds, and collect value kind. Use declared props and values only, and do not guess.",
