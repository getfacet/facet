...
export const FACET_PROMPT_KIT = [
  ...
  "Inside Screen roots, use only component tags present in the active catalog. For unknown contracts, call read_component_spec; follow its content mode, slot cardinalities and allowed tags, structured prop shapes, asset kinds, and collect value kind. Use declared props and values only, and do not guess.",
