...
export const DEFAULT_CATALOG: FacetCatalog = {
  ...
  bricks: [
    ...
    { type: "stat", variants: ["default"], guidance: "Use for compact KPIs and metrics." },
    { type: "badge", variants: ["default"], guidance: "Use for compact statuses and labels." },
    { type: "progress", variants: ["default"], guidance: "Use for bounded percentage progress." },
    { type: "alert", variants: ["default"], guidance: "Use for feedback, warnings, and notices." },
    { type: "list", variants: ["default"], guidance: "Use for capped task or summary lists." },
