...
1. `AGENTS.md` (repo root — the Facet contract; `CLAUDE.md` is a symlink to it).
2. `docs/ARCHITECTURE.md`.
3. `docs/REVIEW-RULES.md` (the P0–P2 severity model).
4. Template: `.claude/skills/feature-intake/templates/feature-intake-template.md`.
5. Consistency checklist: `.claude/skills/feature-intake/references/consistency-checklist.md`.
...
(template: `.claude/skills/feature-intake/templates/feature-intake-template.md`).
