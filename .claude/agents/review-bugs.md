...
transitions, wrong RFC 6902 patch/pointer handling, component document/catalog
validation gaps that let bad state through, wrong JSON parsing, silent data loss.
