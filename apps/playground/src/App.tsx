...
export const SUBTITLES: Record<View, string> = {
  gallery: "Six very different pages — all from Facet's closed brick vocabulary + tokens. No LLM.",
  generated:
    "The page an LLM built with Facet's closed brick vocabulary. Optional reference datasets can inform the result before it is validated and rendered.",
