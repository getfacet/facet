  ...
  return {
    ...
    presets: {
      ...
      media: {
        ...
        navIcon: {
          description: "Generic product navigation icon.",
          useWhen: "Use for sidebar, header, and toolbar control icons.",
          style: {
            width: "fit",
            iconSize: "md",
            padding: "xs",
        ...
        navIconActive: {
          description: "Active generic product navigation icon.",
          useWhen: "Use when a product navigation icon is selected or brand-emphasized.",
          style: {
            width: "fit",
            iconSize: "md",
            padding: "xs",
        ...
        actionIcon: {
          description: "Compact action or overflow icon.",
          useWhen: "Use inside buttons, filters, and toolbar controls.",
          style: {
            width: "fit",
            iconSize: "sm",
            padding: "xs",
