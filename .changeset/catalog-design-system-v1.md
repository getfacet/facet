...
component recipes, bounded composition metadata, and a validated `FacetCatalog`
that controls active theme policy, allowed bricks/variants/compositions,
primitive
...
compositions, and locked theme switches. `@facet/agent` accepts the expanded
container vocabulary when code-authored agents append nodes or expand
compositions.
